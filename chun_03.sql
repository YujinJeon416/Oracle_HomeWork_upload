--================================================================
--2021/01/27 02_워크북_v2.0_AdditionalSelect_Function
--================================================================
...
-- 또 TO_DATE('99/10/11','RR/MM/DD'), TO_DATE('49/10/11','RR/MM/DD')은 각각몇년 몇월 몇일을 의미할까?
...
--단,이때 출력화면의 헤더는 "평점"이라고 찍히게 하고, 점수는 반올림하여 소수점이하 한자리까지만 표시한다.
